...
robot_odom_pose = [0, -3, 0.0]  # x, y position and yaw angle
robot_real_pose = [0, -3, 0.0]  # x, y position and yaw angle
...
prev_robot_odom_x_plot, prev_robot_odom_y_plot = 0, -3
prev_robot_real_x_plot, prev_robot_real_y_plot = 0, -3
...
def plot_initialization():
    ...
    ax.set_xticks([i for i in range(-10,11)],minor= False)
    ax.set_yticks([i for i in range(-15,16)],minor= False)
    ax.set_xticks([i for i in range(-10,11)],minor=True)
    ax.set_yticks([i for i in range(-15,16)],minor=True)
...
def plot_updation(pose, covariance,realpose):
    ...
    ax.plot([robot_odom_x_plot, prev_robot_odom_x_plot], [robot_odom_y_plot, prev_robot_odom_y_plot],'g--')
    prev_robot_odom_x_plot = robot_odom_x_plot
    prev_robot_odom_y_plot = robot_odom_y_plot
    
    # Update robot_real trail
    ax.plot([robot_real_x_plot, prev_robot_real_x_plot], [robot_real_y_plot, prev_robot_real_y_plot],'r--')
    prev_robot_real_x_plot = robot_real_x_plot
    prev_robot_real_y_plot = robot_real_y_plot
